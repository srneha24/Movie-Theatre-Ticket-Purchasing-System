...
<body>
    ...
    <div class="container-fluid">
        <h1 class="text-white text-center title-bg">SOLD TICKETS</h1>
    </div>
            ...
            <div class="bg-white border border-secondary">
                ...
                if (isset($_SESSION['showchoice'])) {
                    if ($_SESSION['showchoice']) {
                        ...
                        <div class="d-flex justify-content-center">
                            <form role="form" action="Includes/Sold Tickets.Inc.php" method="post">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <button class="btn btn-block btn-bg" type="submit" name="soldseats-submit">Done</button>
                                </div>
                            </form>
                        </div>';
